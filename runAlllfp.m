...
%             Out2{i} = pair_stmLFP_mp(d0.ex, d2.ex, d5.exn, d6.exn, 'iLFP_prepro');
...
%             d6 = load([loadpath_mp 'iTrials/' lfplist{i}{2}], 'exn');
            ...
            % analysis
            Out1{i} = pair_stmLFP_mp(d0.ex, d2.ex, d3.exn, d4.exn, 'LFP_prepro', 0);
%             Out2{i} = pair_stmLFP_mp(d0.ex, d2.ex, d5.exn, d6.exn, 'iLFP_prepro', 0);
...
%             exn5_2.Trials = exn5_2.Trials(idx{2});
            ...
            % analysis
            Out1{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn3_0, exn3_2, 'LFP_prepro');
%             Out2{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn5_0, exn5_2, 'iLFP_prepro');
...
%             exn6_2.Trials = exn6_2.Trials(idx{2});
            ...
            % analysis
%             Out3{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn4_0, exn4_2, 'LFP_prepro');
%             Out4{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn6_0, exn6_2, 'iLFP_prepro');
...
%             
            % analysis
            Out1{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn3_0, exn3_2, 'LFP_prepro', 0);
%             Out2{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn5_0, exn5_2, 'iLFP_prepro', 0);
...
%             
%             % analysis
%             Out3{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn4_0, exn4_2, 'LFP_prepro', 0);
%             Out4{i} = pair_stmLFP_mp(ex{1}, ex{2}, exn6_0, exn6_2, 'iLFP_prepro', 0);
%             
            % stimlus type
            if stmtype(i) == 0
                stmtype(i) = find(strcmp(stmtypes, d0.ex.exp.e1.type));
...
%             goodunit(i) = ismember(i, incl_i);
        ...
        try
            ...
            % analysis
            Out1{i} = fitHMM_dataset(d0.ex, [0.05, 0.005], 'or_seq', 'oSpikes', [0.8 0]);
            Out2{i} = fitHMM_dataset(d2.ex, [0.05, 0.005], 'or_seq', 'oSpikes', [0.8 0]);
            clc
